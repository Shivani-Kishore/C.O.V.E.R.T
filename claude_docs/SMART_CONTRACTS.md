...
│
├── Reputation Contracts (Phase 2)
│   ├── ReputationSBT.sol            # Soul-bound tokens
│   └── ReputationManager.sol        # Scoring logic
│
...
## 3. ReputationSBT.sol (Phase 2)

### Purpose
Non-transferable soul-bound tokens representing user reputation levels.
