...
**Goal**: Deploy COVCredits, CovertBadges, and CovertProtocol contracts

#### Smart Contracts:
- [ ] Deploy COVCredits (non-transferable reputation credits)
- [ ] Deploy CovertBadges (soul-bound token badges)
- [ ] Deploy CovertProtocol (staking, review, moderation)
